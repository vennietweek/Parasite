(function(c, e, f, b) {
    ...
    h.prototype.transformSupport = function(v) {
        ...
        var t = null;
        var j = null;
        for (var p = 0, m = this.vendors.length;
        p < m; p++) {
            if (this.vendors[p] !== null) {
                t = this.vendors[p][0] + "transform";
                j = this.vendors[p][1] + "Transform";
            } else {
                t = "transform";
                j = "transform";
            }
        ...
        case"3D":
            if (s) {
                var q = f.body || f.createElement("body");
                var u = f.documentElement;
                var k = u.style.overflow;
                if (!f.body) {
                ...
                q.appendChild(o);
                o.style[j] = "translate3d(1px,1px,1px)";
                n = e.getComputedStyle(o).getPropertyValue(t);
                r = n !== b && n.length > 0 && n !== "none";
                u.style.overflow = k;
                q.removeChild(o);
            }
            break;
